...
<body>
    ...
    @php
        $oldPapers = $data->where('category', 'Old Paper');
    @endphp
    ...
    @if ($oldPapers->isEmpty())
        <div class="row g-2 justify-content-center">
            ...
            <p class="text-primary text-center mt-4">OLD PAPER ARE NOT AVAILABLE</p>
        </div>
    @else
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title bg-white text-center text-primary px-3">Old Paper</h6>
                    <h1 class="mb-5">All Old Paper</h1>
                </div>
                <div class="row g-4 justify-content-center">
                    @foreach ($oldPapers as $file)
